...
<form method="POST" action="{{ route('admin.update', $product) }}" enctype="multipart/form-data">
    ...
    <div class="row py-4 px-5">
        <div class="col-12 col-sm-6 px-5 mb-3">
            ...
            <input type="text" name="product_name" id="productName" class="input-box form-control" value="{{ old('productName', $product->name) }}">
        </div>
        <div class="col-12 col-sm-6 px-5 mb-3">
            <label for="productPrice" class="form-label">Product Price</label>
            <input type="number" name="product_price" id="productPrice" class="input-box form-control" value="{{ old('productPrice', number_format($product->price)) }}">
        </div>
        <div class="col-12 col-sm-6 px-5 mb-3">
            <label for="productColor" class="form-label">Product Color</label>
            <input type="text" name="product_color" id="productColor" class="input-box form-control" value="{{ old('productColor', $product->color) }}">
        </div>
        <div class="col-12 col-sm-6 px-5 mb-3">
            <label for="productPrice" class="form-label">Discount</label>
            <input type="number" name="product_discount" id="productDiscount" class="input-box form-control" value="{{ old('productDiscount', $product->discount_percent) }}">
        </div>
        <div class="col-12 px-5 mb-3">
            <label for="briefDescription" class="form-label">Brief description</label>
            <input type="text" name="brief_description" id="briefDescription" class="input-box form-control" value="{{ old('shortDescription', $product->brief_description) }}">
        </div>
        <div class="col-12 px-5 mb-3">
